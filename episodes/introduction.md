...
2. Pick a strength of the magnetic gradient. This is recorded in the
  <code>.bval</code> file.
...
(dictionary-like data storage) using the <code>get\_metadata()</code>
...
- High performance. Many algorithms implemented in [Cython](https://cython.org/).
